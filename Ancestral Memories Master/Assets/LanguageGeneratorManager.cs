...
public class LanguageGeneratorManager : MonoBehaviour { 
...
public enum Consonants
    ...
    public LanguageGenerator languageGenerator;
    ...
    public string Translate(string englishInput, Dictionary<string, string> dictionary, Func<string, string, string> grammarRules)
    {
        ...
        foreach (string token in tokens)
        {
            ...
            string blendedWord = languageGenerator.BlendWords(translatedWordNeanderthal ?? "", translatedWordMidSapien ?? "", translatedWordSapien ?? "");
    ...
    public string StringLerp(string a, string b, float fraction)
    {
    ...
    public string[] TokenizeEnglish(string englishInput)
    {
