...
public class ObjectPool
{
    ...
    public static ObjectPool CreateInstance(PoolableObject Prefab, int Size)
    {
        ...
        UnityEngine.GameObject poolGameObject = new UnityEngine.GameObject(Prefab + " Pool");
    ...
    private void CreateObjects(UnityEngine.GameObject parent)
    {
        ...
        {
            PoolableObject poolableObject = UnityEngine.GameObject.Instantiate(Prefab, Vector3.zero, Quaternion.identity, parent.transform);
