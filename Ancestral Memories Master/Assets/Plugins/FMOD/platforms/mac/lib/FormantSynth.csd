...
button bounds(90, 80, 90, 50), channel("toggleInstrument"), identChannel("toggleInstrumentID"), text("Loop: OFF"), latched(1), colour(255, 0, 0), fontColour(255, 255, 255)
...
rslider bounds(300, 70, 60, 60), channel("lfoFrequency"), range(0.1, 10, 3), text("LFO Frequency"), trackerColour(0, 0, 255, 255)
rslider bounds(360, 70, 60, 60), channel("lfoDepth"), range(0, 1, 0.1), text("LFO Depth"), trackerColour(0, 0, 255, 255)
rslider bounds(420, 70, 60, 60), channel("lfoWaveform"), range(0, 1, 0), text("LFO Waveform"), trackerColour(0, 0, 255, 255)
...
plant("NoiseAmount") {
    hslider bounds(550, 100, 200, 20), channel("noiseAmountSlider"), range(0, 1, 0.3), text("Breathiness") trackerColour(0, 0, 255, 255)
...
plant("AMPADSR") {
    ...
    hslider bounds(550, 170, 200, 25), channel("ampAttack"), range(0.3, 1, 0.01), text("Attack") trackerColour(0, 0, 255, 255)
    ...
    hslider bounds(550, 260, 200, 25), channel("ampRelease"), range(0.1, 10, 0.5), text("Release") trackerColour(0, 0, 255, 255)
}
...
instr UpdateGUI
    ...
    kToggleInstrument chnget "toggleFilter"
    kTrigInstrument changed kToggleInstrument 
