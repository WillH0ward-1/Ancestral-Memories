...
form caption("Terrain Sound"), size(450, 880), guiMode("polling"), colour(0, 0, 0), pluginId("ter1")
    ...
    hslider bounds(20, 730, 400, 25) channel("roughness") range(0, 1, 0) text("Roughness") colour(145, 145, 145) trackerColour(85, 153, 178)

    groupbox bounds(10, 765, 430, 50) text("StepLength") colour(35, 35, 35)
    hslider bounds(20, 785, 400, 25) channel("stepLength") range(0, 1, 0.5) text("Step Length") colour(145, 145, 145) trackerColour(0, 200, 0)  // Green for Grass
