...
{
    public List<string> Action = new List<string> { "Action_BentKnees_ForageGround", "Action_Fatigue_WipeSweat", "Action_Item_PickUp", "Action_Item_PullFromGround", "Action_KneesToStanding_FinishPray", "Action_OnKnee_Drink01", "Action_OnKnee_ForageGround", "Action_OnKnees_DigAndPlant", "Action_OnKnees_PlantSeeds", "Action_OnKnees_PrayToGround", "Action_OnKnees_PrayToSky", "Action_PetAnimal", "Action_Pose_PickedUpByBack", "Action_PrayTowardsSky_Floating", "Action_Standing_Eat01", "Action_Standing_Eat02", "Action_Standing_Eat03", "Action_Standing_Equip", "Action_Standing_HarvestTree", "Action_Standing_Prayer", "Action_Standing_ScatterSeeds01", "Action_Standing_ScatterSeeds02", "Action_STanding_Vomit", "Action_StandingToKnees_ToPrayer", "Action_StandToKnee_HealGround", "Action_Zombie_Bite_Forward", "Action_Zombie_Eat_FromGround" };
